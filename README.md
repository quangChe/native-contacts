...
Simple contact list app using a fake list of JSON data. This project experiments with the React Navigation library for React Native. Not all features are fully built.
